...
namespace acidphantasm_accessibilityindicators
{
    internal static class AccessibilityIndicatorsConfig
    {
        ...
        public static void InitAAConfig(ConfigFile config)
        {
            ...
            poolObjectsSteps = config.Bind(ConfigStepsTitle, "Pool Objects", 50, new ConfigDescription("Number of indicator clones to make. Increase this if indicators are not showing when they should.", new AcceptableValueRange<int>(25, 100), new ConfigurationManagerAttributes { Order = loadOrder-- }));
